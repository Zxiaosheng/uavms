...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.chart4 = echarts.init(document.getElementById(this.id4));
      this.chart5 = echarts.init(document.getElementById(this.id5));
...
//          //将起始时间的日期
//          let dayBegin = this.aaa[0]
//          let dayEnd = this.aaa[1]
//          var date = new Date('dayBegin');
//
...
//        }
        ...
        //男女生比例图
        let maxData = (this.getData.man) + (this.getData.women);
        this.chart3.setOption({
          ...
          series: [{
            ...
            data: [this.getData.man, this.getData.women],
            markLine: {
              symbol: 'none',
              label: {
                normal: {
