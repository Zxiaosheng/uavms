  ...
  export default {
    ...
    methods: {
      initChart(){
        ...
        let XAData = targetValue1,
          XNData = targetValue2,
          YCData = targetValue3;
        let XIYData = exportValue1,
          XNNData = exportValue2,
          INCData = exportValue3;
        let planePath = 'path://M1705.06,1318.313v-89.254l-319.9-221.799l0.073-208.063c0.521-84.662-26.629-121.796-63.961-121.491c-37.332-0.305-64.482,36.829-63.961,121.491l0.073,208.063l-319.9,221.799v89.254l330.343-157.288l12.238,241.308l-134.449,92.931l0.531,42.034l175.125-42.917l175.125,42.917l0.531-42.034l-134.449-92.931l12.238-241.308L1705.06,1318.313z';
        let convertData = function(data) { // 数据转换，将数据转换为res数组的模式
          var res = [];
        ...
        let colorImport = ['red', 'red', 'red']; //航线的颜色
        ...
        series.push({
          ...
          data: [{
            name: '西安',
            value: geoCoordMap['西安']
              .concat([100]),
          },
            {
              name: '西宁',
              value: geoCoordMap['西宁']
                .concat([100]),
            },
            {
              name: '银川',
              value: geoCoordMap['银川']
                .concat([100]),
            }
          ],
        });
